...
export function buildSupplies(classId: string, teacherName: string): SupplyItem[] {
  return [
    {
      id: `${classId}-supply-1`,
      classId,
      ...
      dueDate: "2026-08-04",
      comments: [
        { id: `${classId}-supply-1-c1`, authorName: "이서준 부모님", authorRole: "parent", text: "네 선생님, 준비해서 보낼게요!", createdAt: NOW - 1000 * 60 * 60 * 10 },
      ],
    },
    {
      id: `${classId}-supply-2`,
